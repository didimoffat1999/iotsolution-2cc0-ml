Scaling [iotsolution-2cc0-ml] With Kubernetes
===========================
...
Based on your TML solution [iotsolution-2cc0-ml] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`iotsolution-2cc0-ml.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-iotsolution-2cc0-ml.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressiotsolution-2cc0-ml.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f iotsolution-2cc0-ml.yml

iotsolution-2cc0-ml.yml
------------------------

.. important::
   Copy and Paste this YAML file: iotsolution-2cc0-ml.yml - and save it locally.

   These YML files can also be found on GitHub at: https://github.com/didimoffat1999/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/iotsolution-2cc0/ymls/iotsolution-2cc0-ml
...
.. code-block:: YAML
   ...
   ################# iotsolution-2cc0-ml.yml
     ...
     kind: Deployment
     metadata:
       name: iotsolution-2cc0-ml
     spec:
       selector:
         matchLabels:
           app: iotsolution-2cc0-ml
       ...
       template:
         ...
         spec:
           containers:
           - name: iotsolution-2cc0-ml
             image: didimoffat1999/iotsolution-2cc0-ml-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'iotsolution-2cc0'                              
             - name: SOLUTIONNAME
               value: 'iotsolution-2cc0-ml'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_ml_dag-iotsolution-2cc0'
             - name: GITUSERNAME
               value: 'didimoffat1999'
             - name: GITREPOURL
               value: 'https://github.com/didimoffat1999/raspberrypi.git'
             ...
             - name: VIPERVIZPORT
               value: '9005'
             - name: MQTTUSERNAME
               value: 'preciousmoffat56@gmail.com'
             - name: AIRFLOWPORT
               value: '9000'
             - name: GITPASSWORD
               valueFrom:
   ...
   ---
     ...
     kind: Service
     metadata:
       name: iotsolution-2cc0-ml-visualization-service
       labels:
         app: iotsolution-2cc0-ml-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/iotsolution-2cc0-ml 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-iotsolution-2cc0-ml.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-iotsolution-2cc0-ml.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-iotsolution-2cc0-ml.yml
