[iotsolution-2cc0-ml] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [iotsolution-2cc0-ml] container is NOT running**.

.. tip::
   You must have your [iotsolution-2cc0-ml] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/didimoffat1999/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/didimoffat1999/raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36971  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='didimoffat1999'  \-\-env DOCKERUSERNAME='didimoffat1999'  \-\-env MQTTUSERNAME='preciousmoffat56@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
[iotsolution-2cc0-ml] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/didimoffat1999/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/iotsolution-2cc0
...
.. important::
   solution_preprocessing_ml_dag-iotsolution-2cc0
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=46291, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=35067, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=33545, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=46665, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=44355, HPDEHOST=172.17.0.2, HPDEPORT=39213, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=36775

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6100-iotsolution-2cc0-ml,solution_preprocessing_ml_dag-iotsolution-2cc0, python-preprocess-9606-iotsolution-2cc0-ml,solution_preprocessing_ml_dag-iotsolution-2cc0, python-ml-3442-iotsolution-2cc0-ml,solution_preprocessing_ml_dag-iotsolution-2cc0, python-predict-288-iotsolution-2cc0-ml,solution_preprocessing_ml_dag-iotsolution-2cc0, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
